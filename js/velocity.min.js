        ...
        var o, p = function() {
            ...
            s = {
                ...
                isWrapped: function(a) {
                    return a && (s.isArray(a) || s.isNumber(a.length) && !s.isString(a) && !s.isFunction(a))
                },
                isSVG: function(a) {
                                    ...
                                    for (r = y.Hooks.fixColors(r), p = y.Hooks.fixColors(p); A < r.length && B < p.length;) {
                                        ...
                                        if (/[\d\.]/.test(H) && /[\d\.]/.test(I)) {
                                            ...
                                            if (A += O.length, B += P.length, O === P) J === K ? g += J + O : (g += "{" + C.length + (F ? "!" : "") + "}" + O, C.push(parseFloat(J)), D.push(parseFloat(K)));
                                                ...
                                                var Q = parseFloat(J),
                                                    R = parseFloat(K);
                                                g += (E < 5 ? "calc" : "") + "(" + (Q ? "{" + C.length + (F ? "!" : "") + "}" : "0") + O + " + " + (R ? "{" + (C.length + 1) + (F ? "!" : "") + "}" : "0") + P + ")", Q && (C.push(parseFloat(J)), C.push(parseFloat(0))), R && (D.push(parseFloat(0)), D.push(parseFloat(K)))
                                            }
                                        } else {
                                            if (H !== I) {
                                                E = 0;
